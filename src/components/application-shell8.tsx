  ...
  return (
    <Sidebar collapsible="icon" {...props}>
      <SidebarHeader className="p-3">
        <a href="/dash">
          <img src="/logo.png" alt="Prevema" className="size-14 object-contain" />
        </a>
      </SidebarHeader>
          ...
          <SidebarGroupContent className="flex flex-col gap-2">
            {sidebarModules.map((moduleItem) => {
              ...
              return (
                ...
                >
                  <moduleItem.icon className="size-6" />
                </button>
              )
            })}
          </SidebarGroupContent>
    ...
    >
      ...
      <div className="flex min-w-0 flex-1 flex-col overflow-hidden">
        <header className="flex h-14 shrink-0 items-center justify-between border-b bg-background px-4">
          <div className="flex items-center">
            <div className="mr-2 flex items-center md:hidden">
              <a href="/dash" className="flex aspect-square size-10 items-center justify-center">
                <img src="/logo.png" alt="Prevema" className="size-10 object-contain" />
              </a>
            </div>
            {activeModule === 'emails' ? (
              <FolderTabs
        ...
        <div className="flex min-h-0 flex-1 overflow-hidden pb-14 md:pb-0">
          ...
          <SidebarInset className="hidden min-h-0 md:flex">
