    ...
    <div ref={ref} className={cn("p-2", className)} {...props}>
          ...
          <div className="flex items-center justify-between gap-2 px-4 py-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-default-400 text-xs">Visa credit card ending in ***4242</p>
              </div>
            </div>
            <Button
      ...
      <div>
        ...
        <p className="text-default-400 mt-1 text-sm font-normal">
          Your free trial ends in <span className="text-default-500">14 days.</span>
        </p>
        {/* Plan radio group */}
        <RadioGroup
          className="mt-4"
      ...
      <div className="mt-2 space-y-2">
        ...
        <div className="flex items-center gap-2">
          <Select defaultSelectedKeys={["ca"]}>
            {stateOptions.map((stateOption) => (
              <SelectItem key={stateOption.value}>{stateOption.label}</SelectItem>
            ))}
          </Select>
          <Input placeholder="Postal Code" />
        </div>
        <Select defaultSelectedKeys={["us"]}>
