...
// Predefined color palettes inspired by modern design tools
const colorPalettes = {
  gradients: [
...
export default function ColorPalettePicker({
  ...
  const handleGradientClick = (colors: string[]) => {
    // For now, use the first color of the gradient
    // In the future, this could set a gradient background
