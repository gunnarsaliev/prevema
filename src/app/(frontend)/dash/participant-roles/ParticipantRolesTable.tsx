...
import { CreateParticipantRoleDrawer } from '../participants/create/CreateParticipantRoleDrawer'

export function ParticipantRolesTable({
  participantRoles,
}: {
      ...
      <div className="mt-8 space-y-4">
        <div className="flex flex-col gap-3 py-2 sm:flex-row sm:items-center">
          ...
          <span className="text-sm text-muted-foreground sm:ml-auto">
            {table.getFilteredRowModel().rows.length} participant role
