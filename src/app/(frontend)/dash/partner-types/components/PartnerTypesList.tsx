...
export function PartnerTypesList({ partnerTypes }: Props) {
  ...
  const columns: ColumnDef<PartnerType>[] = [
    ...
    },
    {
      id: 'actions',
      cell: ({ row }) => {
        const partnerType = row.original
        const isDeleting = deletingId === partnerType.id
        const isCopied = copiedId === partnerType.id
          ...
          <div className="flex justify-end">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                {partnerType.publicFormLink && (
                  <>
                    <DropdownMenuItem
                      onClick={() => handleCopy(partnerType.id, partnerType.publicFormLink!)}
                    >
                      {isCopied ? (
                ...
                <DropdownMenuItem asChild>
                  <Link href={`/dash/partner-types/${partnerType.id}/edit`}>
                ...
                <DropdownMenuItem
                  disabled={isDeleting}
                  onClick={() => handleDelete(partnerType.id, partnerType.name)}
