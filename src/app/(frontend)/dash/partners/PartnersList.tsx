...
function partnerToItem(p: Partner, eventId?: string): QuickViewItem {
  const baseHref = eventId
    ? `/dash/events/${eventId}/partners/${p.id}`
    : `/dash/partners/${p.id}`
              ...
              <TableCell>
                <Dropdown>
                  ...
                  <DropdownMenu anchor="bottom end">
                    <DropdownItem href={eventId ? `/dash/events/${eventId}/partners/${p.id}` : `/dash/partners/${p.id}`}>View</DropdownItem>
                    <DropdownItem onClick={() => setSelected(partnerToItem(p, eventId))}>Preview</DropdownItem>
                    <DropdownItem href={`/dash/partners/${p.id}/edit`}>Edit</DropdownItem>
