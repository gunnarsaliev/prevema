...
export function PartnerForm(props: Props) {
  ...
  const [localPartnerTypes, setLocalPartnerTypes] = useState<PartnerTypeOption[]>(props.partnerTypes)
  ...
  const action =
    props.mode === 'edit' ? updatePartner.bind(null, props.partnerId) : createPartner
          ...
          <AccordionItem value="more-details" className="border rounded-lg px-6 bg-card">
            ...
            <Field data-invalid={!!state?.errors?.companyLogoUrl}>
              ...
              {state?.errors?.companyLogoUrl && (
                <p className="text-sm text-destructive mt-1">{state.errors.companyLogoUrl[0]}</p>
              )}
            </Field>
                ...
                companyBannerFiles.length === 0 && (
                  <div className="mb-4">
                    <div className="relative flex items-center gap-2.5 rounded-md border p-3 bg-background">
                      ...
                      <div className="flex min-w-0 flex-1 flex-col">
                        <span className="truncate font-medium text-sm">Current company banner</span>
                        <span className="truncate text-muted-foreground text-xs">
