...
export function ParticipantForm(props: Props) {
  ...
  const existingProfileImageUrl =
    props.mode === 'edit' ? props.existingProfileImageUrl : null
  ...
  const action =
    props.mode === 'edit'
      ? updateParticipant.bind(null, props.participantId)
      : createParticipant
      ...
      <form onSubmit={handleSubmit} className="space-y-6 max-w-3xl">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Essential details and contact information for the participant</CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Field data-invalid={!!state?.errors?.participantRole}>
                ...
                {state?.errors?.participantRole && (
                  <p className="text-sm text-destructive mt-1">{state.errors.participantRole[0]}</p>
                )}
              </Field>
            </div>
          ...
          <AccordionItem value="more-details" className="border rounded-lg px-6 bg-card">
            <AccordionTrigger>
              <div className="flex flex-col items-start gap-1 text-left">
                ...
                <span className="text-xs text-muted-foreground font-normal">Profile, company information, and presentation details</span>
              </div>
            </AccordionTrigger>
            <AccordionContent>
                ...
                companyLogoFiles.length === 0 && (
                  <div className="mb-4">
                    <div className="relative flex items-center gap-2.5 rounded-md border p-3 bg-background">
                      ...
                      <div className="flex min-w-0 flex-1 flex-col">
                        <span className="truncate font-medium text-sm">Current company logo</span>
                        <span className="truncate text-muted-foreground text-xs">
            ...
            <Field data-invalid={!!state?.errors?.companyWebsite}>
              ...
              {state?.errors?.companyWebsite && (
                <p className="text-sm text-destructive mt-1">{state.errors.companyWebsite[0]}</p>
              )}
            </Field>
